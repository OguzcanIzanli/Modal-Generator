...
const Template7: React.FC<TemplateProps> = ({ modalData }) => {
  ...
  return (
    <>
      {isModalVisible && (
        <div
          className={`flex text-left rounded-xl w-min text-black font-sans shadow-[0_0_12px_rgba(0,0,0,0.25)] items-center bg-white transition-transform duration-1000 ease-out ${
            id
